...
{
    public class AutenticacionExtensiones : AuthenticationStateProvider
    {
        private readonly ILocalStorageService _localStorage;
        private ClaimsPrincipal _sinInformacion = new ClaimsPrincipal(new ClaimsIdentity());

        public AutenticacionExtensiones(ILocalStorageService localStorage)
        {
        ...
        public async Task ActualizarEstadoAutenticacion(SesionDTO? sesionUsuario)
        {
            ...
            if(sesionUsuario != null)
            {
                ...
                {
                    new Claim(ClaimTypes.NameIdentifier,sesionUsuario.IdUsuarioE.ToString()),
