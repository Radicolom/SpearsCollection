...
namespace Ecommerce.API.Controllers
{
    ...
    public class CategoriaController : ControllerBase
    {
        ...
        {
            var response = new ResponseDTO<List<CategoriaEcommerceDTO>>();
        ...
        {
            var response = new ResponseDTO<CategoriaEcommerceDTO>();
        ...
        public async Task<IActionResult> Crear([FromBody]CategoriaEcommerceDTO modelo)
        {
            var response = new ResponseDTO<CategoriaEcommerceDTO>();
        ...
        public async Task<IActionResult> Editar([FromBody] CategoriaEcommerceDTO modelo)
        {
