...
namespace Ecommerce.API.Controllers
{
    ...
    public class ProductoController : ControllerBase
    {
        ...
        {
            var response = new ResponseDTO<List<ProductoEcommerceDTO>>();
        ...
        {
            var response = new ResponseDTO<ProductoEcommerceDTO>();
        ...
        public async Task<IActionResult> Crear([FromBody]ProductoEcommerceDTO modelo)
        {
            var response = new ResponseDTO<ProductoEcommerceDTO>();
        ...
        public async Task<IActionResult> Editar([FromBody] ProductoEcommerceDTO modelo)
        {
